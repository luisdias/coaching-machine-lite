...
define('STEP1_LIST5', 'Lingua');
define('STEP1_DLIST5', 'Seleziona la lingua da installare');
...
define('SUCCESS_BUTTON', 'Installare');
...
define('ERRO_CONNETION_BUTTON', 'Riprova');

/**
* End
*/
define('SUCCESS_END_TEXT', 'Complimenti! L\'installazione è stata completata con successo. Ricordarsi di eliminare la cartella install prima di usare la Coaching Machine');
define('SUCCESS_END_BUTTON', 'Inizio');
