...
define('STEP1_LIST5', 'Idioma');
define('STEP1_DLIST5', 'Seleccione o idioma para instalar');
...
define('SUCCESS_BUTTON', 'Ejecute la instalación');
/**
* Erros
*/
// unknown error
...
define('ERRO_CONNETION_BUTTON', 'Inténtalo de nuevo');

/**
* End
*/
define('SUCCESS_END_TEXT', '¡Enhorabuena! La instalación finalizó satisfactoriamente. Recuerde borrar la carpeta install antes de empezar a utilizar el Coaching Machine');
define('SUCCESS_END_BUTTON', 'Comenzar');