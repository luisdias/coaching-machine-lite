...
define('STEP1_LIST5', 'Language');
define('STEP1_DLIST5', 'Select the language to install');
...
define('SUCCESS_BUTTON', 'Run the install');
/**
 * Erros
 */
// unknown error
...
define('ERROUNKNOW_TEXT3', 'After you&#8217;ve done that, click &#8220;Run the install.&#8221;');
...
define('ERRO_CONNETION_BUTTON', 'Try again');

/**
* End
*/
define('SUCCESS_END_TEXT', 'Congratulations! The installation was completed successfully. Remember to delete the install folder before you start using the Coaching Machine');
define('SUCCESS_END_BUTTON', 'Start');