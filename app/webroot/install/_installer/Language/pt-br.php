...
define('STEP1_DLIST5', 'Selecione o idioma para a sua instalação');
...
define('SUCCESS_BUTTON', 'Instalar');
...
define('ERRO_CONNETION_BUTTON', 'Tente novamente');

/**
* End
*/
define('SUCCESS_END_TEXT', 'Parabéns! A instalação foi concluída com sucesso. Lembre-se de apagar a pasta install antes de começar a utilizar o Coaching Machine');
define('SUCCESS_END_BUTTON', 'Começar');